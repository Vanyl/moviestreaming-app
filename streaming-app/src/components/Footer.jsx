    ...
    return (
        <>
            ...
            <ul className="text-blue-300 list-none font-semibold flex justify-center gap-x-4">
                <li className="hover:text-blue-200">Conditions d'utilisations et Politique de confidentialité</li>
                <li className="hover:text-blue-200">Donnez-nous votre avis</li>
                <li className="hover:text-blue-200">Aide</li>
                <li className="hover:text-blue-200">Avertissement relatif aux cookies</li>
